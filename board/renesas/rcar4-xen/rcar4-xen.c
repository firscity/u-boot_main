...
static int setup_mem_map(void)
{
	...
	/* Region for Renesas SoC peripherals */
	xen_mem_map[i].virt = 0xC0000000UL;
	xen_mem_map[i].phys = 0xC0000000UL;
	xen_mem_map[i].size = 0x40000000UL;
